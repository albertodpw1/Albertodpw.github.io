     ...
     //funcion onmouseover ver para cargar la funcion para a descripcion del primer producto
     function onmouseover1(){    
        alert('Bolso de chaquira')
    }
         //funcion onmouseover ver para cargar la funcion para a descripcion del segundo producto

    function onmouseover2(){    
        alert('Pulsera para dama')

    }
         //funcion onmouseover ver para cargar la funcion para a descripcion del tercer producto
 function onmouseover3(){    
        alert('LLavero de tortuga hecho a mano')

    } 
         //funcion onmouseover ver para cargar la funcion para a descripcion del cuarto producto
function onmouseover4(){    
        alert('Anillo para caballero')
    } 
         //funcion onmouseover ver para cargar la funcion para a descripcion del quinto producto
